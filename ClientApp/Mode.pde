class Mode {
  ...
  void ending(int mode_) {
    ...
    else if (mode_ == 6) txt = "満足しました\nあなたの勝ちです";
    else if (mode_ == 5) txt = "満足できませんでした\nあなたの負けです";
    else if (mode_ == 9) txt = "相手の肉を喰らいました\nあなたの勝ちです";
    else if (mode_ == 10) txt = "あなたの心は闇に染まりました\nあなたの負けです";
    else if (mode_ == 7) txt = "相手に肉を取られました\nあなたの負けです";
    else if (mode_ == 8) txt = "相手の心は闇に染まりました\nあなたの勝ちです";
